    ...
    <section id="about" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            Founded by <strong className="text-foreground">Mr. Kaushik Pathak</strong>, our company is built on the core values of integrity, transparency, and strict adherence to global quality standards. Being situated in Gujarat, a state known for its agricultural abundance and robust port connectivity, gives us a strategic advantage in sourcing fresh produce and ensuring rapid logistics.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            We act as your trusted partner on the ground in India, bridging the gap between local farmers and international buyers. Whether it is the aromatic richness of Basmati Rice or the freshness of green chillies and bananas, we ensure that every shipment meets the highest specifications of safety and quality.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground text-center mb-8">
            We focus on three core agricultural categories, ensuring deep expertise and quality control in each:
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
              <h4 className="font-semibold text-foreground mb-2">Fresh Green Chilli</h4>
              <p className="text-sm text-muted-foreground">
                Hand-picked, spicy, and fresh varieties suitable for global cuisines.
              </p>
            </div>
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
              <h4 className="font-semibold text-foreground mb-2">Fresh Cavendish Bananas</h4>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {reasons.map((reason, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex gap-4 bg-card p-6 rounded-xl border border-border shadow-sm"
              >
